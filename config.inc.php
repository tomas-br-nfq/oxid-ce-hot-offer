 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbName = 'oxid_ce_hot_offer'; // database name
        $this->dbUser = 'root'; // database user name
        $this->dbPwd = 'root'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://oxid-ce-hot-offer'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '/home/tomas/Workspace/oxid-ce-hot-offer';
        $this->sCompileDir = '/home/tomas/Workspace/oxid-ce-hot-offer/tmp';
